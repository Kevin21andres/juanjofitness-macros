  ...
  return (
    <div className="min-h-screen bg-[#0B0B0B] p-6 space-y-12">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Link href="/calculator" className="card group text-center hover:border-[var(--color-accent)] transition">
          <span className="text-4xl mb-3 block">🍽️</span>
          <p className="text-lg font-medium text-white">Calculadora de dieta</p>
          <p className="text-sm text-white/60">Planifica comidas y macros</p>
        </Link>

        <Link href="/clients/new" className="card group text-center hover:border-[var(--color-accent)] transition">
          <span className="text-4xl mb-3 block">➕</span>
          <p className="text-lg font-medium text-white">Crear cliente</p>
          <p className="text-sm text-white/60">Nuevo seguimiento</p>
        </Link>

        <Link href="/clients" className="card group text-center hover:border-[var(--color-accent)] transition">
          <span className="text-4xl mb-3 block">👥</span>
      ...
      <section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          ...
          <div className="card">
            <p className="text-xs text-white/50">Dietas creadas</p>
            <p className="text-3xl font-semibold text-white mt-2">
          ...
          <div className="card">
            <p className="text-xs text-white/50">Última actividad</p>
